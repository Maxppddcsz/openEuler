...
Release: %{devel_release}%{?maintenance_release}%{?rt_release}%{?pkg_release}%{?extra_release}
...
* Wed Feb 06 2023 kylin-liyulei <liyulei@kylinos.cn> - 5.10.0-60.73.0.56
- update preempt-rt kernel to 5.10.0-60.73.0
