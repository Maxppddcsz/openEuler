...
static int loongson_pcm_trigger(struct snd_soc_component *component, struct snd_pcm_substream *substream, int cmd)
{
...
static int loongson_pcm_hw_params(struct snd_soc_component *component, struct snd_pcm_substream *substream,
...
loongson_pcm_pointer(struct snd_soc_component *component, struct snd_pcm_substream *substream)
{
	struct snd_pcm_runtime *runtime = substream->runtime;
	struct loongson_runtime_data *prtd = runtime->private_data;
	struct loongson_dma_desc *desc;
...
static int loongson_pcm_open(struct snd_soc_component *component, struct snd_pcm_substream *substream)
{
...
static int loongson_pcm_close(struct snd_soc_component *component, struct snd_pcm_substream *substream)
{
	struct snd_soc_pcm_runtime *rtd = substream->private_data;
	struct snd_card *card = substream->pcm->card;
	struct loongson_runtime_data *prtd = substream->runtime->private_data;
...
static int loongson_pcm_mmap(struct snd_soc_component *component, struct snd_pcm_substream *substream,
...
static int loongson_pcm_new(struct snd_soc_component *component, struct snd_soc_pcm_runtime *rtd)
{
