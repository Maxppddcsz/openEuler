...
static const u32 zxi2c_speed_params_table[][3] = {
	...
	{ I2C_MAX_HIGH_SPEED_MODE_FREQ, ZXI2C_TCR_HS_MODE | ZXI2C_TCR_FAST, ZXI2C_GOLD_FSTP_3400K },
...
static void zxi2c_get_bus_speed(struct zxi2c *i2c)
{
	...
	if (abs(fstp - params[2]) > 0x10) {
		/* if BIOS setting value far from golden value, use golden value and warn user */
