...
MODULE_PARM_DESC(zhaoxin_em_type,
	"AHCI Enclosure Management Message type control"
	"(1 = led on, 2 = sgpio on,3 = sgpio gp on)");
...
const static struct sysfs_ops sgpio_zhaoxin_sysfs_ops = {
	.show	= sgpio_zhaoxin_attr_show,
	.store	= sgpio_zhaoxin_attr_store,
};

static struct kobj_type sgpio_zhaoxin_ktype = {
	.sysfs_ops	= &sgpio_zhaoxin_sysfs_ops,
	.default_attrs	= sgpio_attrs,
};
