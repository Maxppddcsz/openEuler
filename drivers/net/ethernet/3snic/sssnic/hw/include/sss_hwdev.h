...
#define SSS_CFG_SERVICE_FT_EN	\
			(SSS_CFG_SERVICE_MASK_VBS | SSS_CFG_SERVICE_MASK_TOE | \
			SSS_CFG_SERVICE_MASK_IPSEC | SSS_CFG_SERVICE_MASK_FC | \
			SSS_CFG_SERVICE_MASK_VIRTIO | SSS_CFG_SERVICE_MASK_OVS)
...
#define SSS_IS_FT_TYPE(dev) \
	(((u32)(dev)->mgmt_info->svc_cap.chip_svc_type) & SSS_CFG_SERVICE_FT_EN)
