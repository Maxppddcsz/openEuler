...
/**
 * sss_adm_msg_busy - check if the adm_msg is still processing last requests
 * @adm_msg: adm to check
 **/
...
/**
 * sss_prepare_elem_ctrl - prepare the msg of the elem for the command
 * @elem_ctrl: the control of the elem to set the control into it
 **/
...
/**
 * sss_prepare_elem_desc - prepare ADM MSG command
 * @adm: adm for the command
...
/**
 * sss_prepare_elem_ctx - prepare ADM MSG command
 * @adm_msg: adm for the command
 * @elem: the elem of the command
 * @node_id: destination node on the card that will receive the command
 * @cmd: command data
 * @cmd_size: the command size
 **/
...
/**
 * sss_prepare_elem - prepare elem ctrl and cmd in the current producer elem
 * @adm_msg: adm for the command
 * @node_id: destination node on the card that will receive the command
 * @cmd: command data
 * @cmd_size: the command size
...
/**
 * sss_update_adm_msg_status - update the state of the adm
 * @adm_msg: adm to update
 **/
...
/**
 * sss_wait_for_state_poll - wait for write to mgmt msg to complete
 * @adm_msg: the adm of the command
 * Return: 0 - success, negative - failure
 **/
...
/**
 * sss_wait_for_adm_msg_completion - wait for command to complete
 * @adm_msg: adm for the command
 * Return: 0 - success, negative - failure
 **/
...
/**
 * sss_send_adm_msg - ADM MSG command
 * @adm_msg: adm for the command
 * @node_id: destination node on the card that will receive the command
 * @cmd: command data
...
/**
 * sss_align_adm_msg_len - calculate the total message length
...
/**
 * sss_encapsulate_adm_msg - encapsulate the mgmt command
...
/**
 * sss_send_adm_msg - send async message
...
/**
 * sss_register_mgmt_msg_cb - register sync msg handler for a module
 * @hwdev: the pointer to hw device
 * @mod_type: module in the chip that this handler will handle its sync messages
 * @data: specific mod's private data that will be used in callback
 * @cb: the handler for a sync message that will handle messages
 **/
...
/**
 * sss_unregister_mgmt_msg_handler - unregister sync msg handler for a module
 * @hwdev: the pointer to hw device
 * @mod_type: module in the chip that this handler will handle its sync messages
 **/
