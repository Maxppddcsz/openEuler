...
#define SSS_HWDEV_WQ_NAME				"sss_nic_hardware"
...
#else
static void sss_heartbeat_timer_handler(unsigned long data)
{
	struct sss_hwdev *hwdev = (struct sss_hwdev *)data;
#endif
