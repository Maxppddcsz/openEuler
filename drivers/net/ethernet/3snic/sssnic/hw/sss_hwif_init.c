...
#define SSS_AF0_P2P_ID_SHIFT			12
...
#define SSS_AF0_P2P_ID_MASK			0x1F
...
#define SSS_AF2_CEQS_PER_FUNC_SHIFT		0
#define SSS_AF2_DMA_ATTR_PER_FUNC_SHIFT	9
#define SSS_AF2_IRQS_PER_FUNC_SHIFT		16

#define SSS_AF2_CEQS_PER_FUNC_MASK		0x1FF
#define SSS_AF2_DMA_ATTR_PER_FUNC_MASK	0x7
#define SSS_AF2_IRQS_PER_FUNC_MASK		0x7FF
...
static int sss_chip_get_func_attr0(struct sss_hwif *hwif)
{
	...
	SSS_SET_HWIF_PORT_TO_PORT_ID(hwif, SSS_GET_AF0(attr, P2P_ID));
...
static int sss_chip_get_func_attr1(struct sss_hwif *hwif)
{
	...
	SSS_SET_HWIF_AEQ_NUM(hwif, BIT(SSS_GET_AF1(attr, AEQS_PER_FUNC)));
...
static int sss_chip_get_func_attr2(struct sss_hwif *hwif)
{
	...
	SSS_SET_HWIF_CEQ_NUM(hwif, (u8)SSS_GET_AF2(attr, CEQS_PER_FUNC));
	SSS_SET_HWIF_IRQ_NUM(hwif, SSS_GET_AF2(attr, IRQS_PER_FUNC));
...
static void sss_hwif_init_chip_pf(struct sss_hwdev *hwdev)
{
