...
enum sss_mgmt_cmd {
	...
	SSS_COMM_MGMT_CMD_FFM_SET, /* check if needed */
...
enum sss_func_reset_flag {
	...
	SSS_RESET_TYPE_COMM_MGMT_CH,  /* clear mbx and aeq, The
				       * SSS_RESET_TYPE_COMM bit must be set
				       */
	SSS_RESET_TYPE_COMM_CMD_CH,   /* clear ctrlq and ceq, The
				       * SSS_RESET_TYPE_COMM bit must be set
				       */
	SSS_RESET_TYPE_NIC,
	SSS_RESET_TYPE_OVS,
