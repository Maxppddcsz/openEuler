...
#define SSSNIC_FPGA_PORT_COUNTER   0
#define SSSNIC_EVB_PORT_COUNTER    1
...
do { \
	...
	for (i = 0; i < g_hw2ethtool_link_mode_table[mode].bitmap_len; i++) { \
		if (g_hw2ethtool_link_mode_table[mode].bitmap[i] >= \
			__ETHTOOL_LINK_MODE_MASK_NBITS) \
			continue; \
		set_bit(g_hw2ethtool_link_mode_table[mode].bitmap[i], val); \
	} \
} while (0)
...
static const struct sss_nic_hw2ethtool_link_mode
	g_hw2ethtool_link_mode_table[SSSNIC_LINK_MODE_MAX_NUMBERS] = {
	[SSSNIC_LINK_MODE_GE] = {
		.bitmap = g_mag_link_mode_ge,
		.bitmap_len = ARRAY_LEN(g_mag_link_mode_ge),
		.speed = SPEED_1000,
	},
	[SSSNIC_LINK_MODE_10GE_BASE_R] = {
		.bitmap = g_mag_link_mode_10ge_base_r,
		.bitmap_len = ARRAY_LEN(g_mag_link_mode_10ge_base_r),
		.speed = SPEED_10000,
	},
	[SSSNIC_LINK_MODE_25GE_BASE_R] = {
		.bitmap = g_mag_link_mode_25ge_base_r,
		.bitmap_len = ARRAY_LEN(g_mag_link_mode_25ge_base_r),
		.speed = SPEED_25000,
	},
	[SSSNIC_LINK_MODE_40GE_BASE_R4] = {
		.bitmap = g_mag_link_mode_40ge_base_r4,
		.bitmap_len = ARRAY_LEN(g_mag_link_mode_40ge_base_r4),
		.speed = SPEED_40000,
	},
	[SSSNIC_LINK_MODE_50GE_BASE_R] = {
		.bitmap = g_mag_link_mode_50ge_base_r,
		.bitmap_len = ARRAY_LEN(g_mag_link_mode_50ge_base_r),
		.speed = SPEED_50000,
	},
	[SSSNIC_LINK_MODE_50GE_BASE_R2] = {
		.bitmap = g_mag_link_mode_50ge_base_r2,
		.bitmap_len = ARRAY_LEN(g_mag_link_mode_50ge_base_r2),
		.speed = SPEED_50000,
	},
	[SSSNIC_LINK_MODE_100GE_BASE_R] = {
		.bitmap = g_mag_link_mode_100ge_base_r,
		.bitmap_len = ARRAY_LEN(g_mag_link_mode_100ge_base_r),
		.speed = SPEED_100000,
	},
	[SSSNIC_LINK_MODE_100GE_BASE_R2] = {
		.bitmap = g_mag_link_mode_100ge_base_r2,
		.bitmap_len = ARRAY_LEN(g_mag_link_mode_100ge_base_r2),
		.speed = SPEED_100000,
	},
	[SSSNIC_LINK_MODE_100GE_BASE_R4] = {
		.bitmap = g_mag_link_mode_100ge_base_r4,
		.bitmap_len = ARRAY_LEN(g_mag_link_mode_100ge_base_r4),
		.speed = SPEED_100000,
	},
	[SSSNIC_LINK_MODE_200GE_BASE_R2] = {
		.bitmap = g_mag_link_mode_200ge_base_r2,
		.bitmap_len = ARRAY_LEN(g_mag_link_mode_200ge_base_r2),
		.speed = SPEED_200000,
	},
	[SSSNIC_LINK_MODE_200GE_BASE_R4] = {
		.bitmap = g_mag_link_mode_200ge_base_r4,
		.bitmap_len = ARRAY_LEN(g_mag_link_mode_200ge_base_r4),
		.speed = SPEED_200000,
	},
};
...
void sss_nic_set_fibre_port(struct sss_nic_cmd_link_settings *cmd)
{
...
void sss_nic_set_da_port(struct sss_nic_cmd_link_settings *cmd)
{
	SSSNIC_ETHTOOL_ADD_SUPPORTED_LINK_MODE(cmd, FIBRE);
	SSSNIC_ETHTOOL_ADD_ADVERTISED_LINK_MODE(cmd, FIBRE);
	cmd->port = PORT_DA;
...
void sss_nic_set_tp_port(struct sss_nic_cmd_link_settings *cmd)
{
...
void sss_nic_set_none_port(struct sss_nic_cmd_link_settings *cmd)
{
...
void sss_nic_link_port_type(struct sss_nic_cmd_link_settings *cmd,
			    u8 port_type)
{
	sss_nic_port_type_handler_t handler[] = {
		NULL,
	...
	if (handler[port_type])
		handler[port_type](cmd);
	else
		cmd->port = PORT_OTHER;
}
...
bool sss_nic_is_support_speed(u32 support_mode, u32 speed)
{
	...
	for (link_mode = 0; link_mode < SSSNIC_LINK_MODE_MAX_NUMBERS; link_mode++) {
		...
		if (g_hw2ethtool_link_mode_table[link_mode].speed == speed)
			return true;
	}
