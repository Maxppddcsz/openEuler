...
static inline u32 spu_board_type_valid(u32 board_type)
{
	return ((board_type) == BOARD_TYPE_CLD_2X25G_SDI5_0_LITE) || ((board_type) == BOARD_TYPE_CLD_2X100G_SDI5_0) ||
		((board_type) == BOARD_TYPE_CAL_2X25G_DPU) || ((board_type) == BOARD_TYPE_CAL_2X100G_DPU) ||
...
{
	return ((board_type) == BOARD_TYPE_CAL_2X25G_DPU) || ((board_type) == BOARD_TYPE_CAL_2X100G_DPU) ||
	((board_type) == BOARD_TYPE_CAL_4X25G_DPU);
}
