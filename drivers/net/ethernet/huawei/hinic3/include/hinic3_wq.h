...
static inline int sdk_wq_create(void *udkdev, struct hinic3_wq *wq, u32 q_depth, u16 wqebb_size)
{
	void *sdk_hwdev = NULL;
	...
	return hinic3_wq_create(sdk_hwdev, wq, q_depth, wqebb_size);
}

#define hinic3_wq_create    sdk_wq_create
#endif
#endif
