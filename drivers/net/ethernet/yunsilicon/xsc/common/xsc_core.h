...
struct qp_group_refer {
	spinlock_t lock;
	uint16_t refer_cnt[GROUP_REFER_CNT_SIZE];
};
...
static inline void ia_write_data(struct xsc_core_device *xdev, uint32_t *ptr, int n, int iae_idx)
{
	int i;
...
static inline void ia_read_data(struct xsc_core_device *xdev, uint32_t *ptr, int n, int iae_idx)
{
	int i;
	int offset = xdev->regs.cpm_data_mem + (iae_idx) * CPM_IAE_DATA_MEM_STRIDE;
	u32 *pptr = ptr;
...
static inline void ia_write_reg_addr(struct xsc_core_device *xdev, uint32_t reg, int iae_idx)
{
...
static inline void ia_write_reg_mr(struct xsc_core_device *xdev, uint32_t reg,
	uint32_t *ptr, int n, int idx)
{
...
static inline void ia_write(struct xsc_core_device *xdev, uint32_t reg, uint32_t *ptr, int n)
{
	int iae_idx;
...
static inline void ia_read(struct xsc_core_device *xdev, uint32_t reg, uint32_t *ptr, int n)
{
	int iae_idx;
...
static inline uint32_t reg_read32(struct xsc_core_device *dev, uint32_t offset)
{
	uint32_t val = 0;
...
static inline void reg_write32(struct xsc_core_device *dev, uint32_t offset, uint32_t val)
{
	uint32_t *ptr = &val;
