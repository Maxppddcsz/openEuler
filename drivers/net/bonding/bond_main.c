...
/* L2 hash helper */
static inline u32 bond_eth_hash(struct sk_buff *skb, void *data, int mhoff, int hlen)
{
	struct ethhdr *ep;
...
static bool bond_flow_ip(struct sk_buff *skb, struct flow_keys *fk, void *data,
...
static bool bond_flow_dissect(struct bonding *bond, struct sk_buff *skb, void *data,
 ...
 */
static u32 __bond_xmit_hash(struct bonding *bond, struct sk_buff *skb, void *data,
