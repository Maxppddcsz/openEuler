 ...
 *
 * File Name	 : roce_srq.h
 * Version	   : v2.2
 * Created	   : 2021/3/12
 * Last Modified : 2021/12/28
 * Description   : The definition of RoCE SRQ function prototype, macros etc in kernel space.
 */
...
#define SRQ_WQEBB_SIZE_CAL_SECTTOR 4 /* (2^rq_wqebb_size)*16B => divide 16 means shift need to minus 4 */
#define RDMA_PREFETCH_WQE_MAX 7
#define RDMA_PREFETCH_MTT_LEN_MAX 3
#define ROCE_WQE_BB_SIZE_MIN 64

#define LAST_SGE_NO_PRESENT 0x80000000UL			 /* Lbit:0 - The next SGE is present in the list \
													  * Lbit:1 - The last SGE, no SGE is present in the list */
#define NORMAL_FMT_AND_NEXT_SGE_PRESENT 0x3FFFFFFFUL /* Ebit:b0 - Normal format, without extension.				 \
...
static inline struct roce3_srq *cqmobj_to_roce3_srq(const cqm_object_s *object)
{
	cqm_queue_s *cqm_srq;
