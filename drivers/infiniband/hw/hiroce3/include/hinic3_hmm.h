...
/* ****************************************************************************
 ...
 Input		: struct hinic3_hwdev *hwdev
				...
				u64 length ע���ڴ�ĳ���
				u64 virt_addr io�������ַ
				int hmm_acess ����enum rdma_ib_access��ֵ
...
struct hmm_mr *hmm_reg_user_mr(struct hinic3_hwdev *hwdev, u64 start, u32 pdn, u64 length,
	u64 virt_addr, int hmm_acess, u32 service_type, u16 channel);
