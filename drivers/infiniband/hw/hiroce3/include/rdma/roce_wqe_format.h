...
typedef union roce3_wqe_tsk_com_seg {
	struct {
#if defined(BYTE_ORDER) && defined(BIG_ENDIAN) && ((BYTE_ORDER == BIG_ENDIAN))
		u32 se : 1;
		u32 f : 1;
		...
		u32 ext_vld : 1;
		u32 dif_en : 1;
		u32 cs_len_mul : 3; /* * atomic cmp swap N len:atomic datalen=8*(cs_len_mul + 1) */
...
typedef union roce3_wqe_tsk_misc_seg {
	struct {
#if defined(BYTE_ORDER) && defined(BIG_ENDIAN) && ((BYTE_ORDER == BIG_ENDIAN))
		u32 ext_last : 1;
		u32 nxt_ext_hdr : 7;
	...
	u32 value;
} roce3_wqe_tsk_misc_seg_u;

typedef struct roce3_wqe_tsk_rdma_sge_seg {
	/* DW4~5 */
	union {
		u64 va;
		struct {
...
typedef struct roce3_wqe_rdma_tsk_seg {
	...
	/* DW7 */
	u32 sig_key;
} roce3_wqe_rdma_tsk_seg_s;

/* RDMA Read WQE/RDMA Write WQE/RDMA Write with imme WQE(inline or non-inline) */
typedef struct roce3_wqe_rdma_ext_tsk_seg {
	roce_wqe_tsk_com_seg_u common;
	...
	/* DW4~5 */
	roce3_wqe_tsk_rdma_sge_seg_s rdma;

	u32 ulp_cmd[24];
} roce3_wqe_rdma_ext_tsk_seg_s;

/* Atomic WQE */
typedef struct roce3_wqe_atomic_tsk_seg {
	roce_wqe_tsk_com_seg_u common;
...
} roce3_wqe_ext_atomic_tsk_seg_s;

/* Mask Atomic WQE */
typedef struct roce3_wqe_mask_atomic_tsk_seg {
	roce_wqe_tsk_com_seg_u common;
...
} roce3_wqe_mask_atomic_tsk_seg_s;

/* UD send WQE */
typedef struct roce3_wqe_ud_tsk_seg {
	roce_wqe_tsk_com_seg_u common;
	...
	/* DW15 */
	u32 rsvd;
} roce3_wqe_ud_tsk_seg_s;

typedef struct roce3_wqe_data_seg {
	/* DW0~1 */
	union {
		u64 addr;
		struct {
	...
	/* DW4 */
	u32 key;
} roce3_wqe_data_seg_s;

/* Type1/2 MW Bind WQE */
typedef struct roce3_wqe_bind_tsk_seg {
	roce_wqe_tsk_com_seg_u common;
...
} roce3_wqe_bind_tsk_seg_s;

/* Fast Register PMR WQE */
typedef struct roce3_wqe_frmr_tsk_seg {
	roce_wqe_tsk_com_seg_u common;
...
} roce3_wqe_frmr_tsk_seg_s;

typedef struct roce3_sge_info {
	union {
		u64 sge_vaddr;
		struct {
			u32 sge_vaddr_hi;
...
typedef struct roce3_wqe_local_inv_tsk_seg {
	roce_wqe_tsk_com_seg_u common;
	...
	/* DW2 */
	u32 rsvd1;
} roce3_wqe_local_inv_tsk_seg_s;

/* * SRQ Data Format start */
typedef struct roce3_wqe_srq_data_seg {
	/* DW0~1 */
	union {
		u64 addr;
...
} roce3_wqe_srq_data_seg_s;
/* * SRQ Data Format end */

typedef struct roce_osd_srq_link_wqe {
	u32 cont_gpa_h;
