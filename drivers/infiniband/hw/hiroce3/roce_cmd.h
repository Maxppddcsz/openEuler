 ...
 *
 * File Name	 : roce_cmd.h
 * Version	   : v2.0
 * Created	   : 2021/3/14
 * Last Modified : 2021/11/2
 * Description   : The definition of RoCE cmd function prototypes, macros etc.
 */
...
#define roce3_msg_to_mgmt_sync(hwdev, cmd, buf_in, in_size, buf_out, out_size) \
	hinic3_msg_to_mgmt_sync(hwdev, HINIC3_MOD_ROCE, cmd, buf_in, in_size, buf_out, out_size, 0, HINIC3_CHANNEL_ROCE)
...
typedef int (*roce3_modify_mac_tbl)(void *hwdev, u8 *mac_addr, u32 vlan_id, u16 er_fwd_id, u16 func_id);
...
typedef void (*roce3_modify_ipsu_tbl_mac)(void *hwdev, u8 *mac_addr, u32 vlan_id, u16 func_id, u8 er_id);
