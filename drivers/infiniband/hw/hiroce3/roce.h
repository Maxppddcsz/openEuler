 ...
 * Description   : The definition of RoCE MAIN function prototype, macros etc,. in kernel space.
 */
...
#define HIROCE3_DRV_VERSION GLOBAL_VERSION_STR
...
#define roce3_pr_emerg_once(fmt, ...) printk_once(KERN_EMERG pr_fmt(fmt), ##__VA_ARGS__)
#define roce3_pr_alert_once(fmt, ...) printk_once(KERN_ALERT pr_fmt(fmt), ##__VA_ARGS__)
#define roce3_pr_crit_once(fmt, ...) printk_once(KERN_CRIT pr_fmt(fmt), ##__VA_ARGS__)
#define roce3_pr_err_once(fmt, ...) printk_once(KERN_ERR pr_fmt(fmt), ##__VA_ARGS__)
#define roce3_pr_warn_once(fmt, ...) printk_once(KERN_WARNING pr_fmt(fmt), ##__VA_ARGS__)
#define roce3_pr_warn pr_warning
#define roce3_pr_notice_once(fmt, ...) printk_once(KERN_NOTICE pr_fmt(fmt), ##__VA_ARGS__)
#define roce3_pr_info_once(fmt, ...) printk_once(KERN_INFO pr_fmt(fmt), ##__VA_ARGS__)
#define roce3_pr_cont_once(fmt, ...) printk_once(KERN_CONT pr_fmt(fmt), ##__VA_ARGS__)
...
#define ROCE_UVERBS_CMD_MASK																	 \
	((1ULL << IB_USER_VERBS_CMD_GET_CONTEXT) | (1ULL << IB_USER_VERBS_CMD_QUERY_DEVICE) |		\
		...
		(1ULL << IB_USER_VERBS_CMD_DEALLOC_PD) | (1ULL << IB_USER_VERBS_CMD_CREATE_AH) |		 \
		(1ULL << IB_USER_VERBS_CMD_DESTROY_AH) | (1ULL << IB_USER_VERBS_CMD_REG_MR) |			\
		(1ULL << IB_USER_VERBS_CMD_DEREG_MR) | (1ULL << IB_USER_VERBS_CMD_CREATE_COMP_CHANNEL) | \
		(1ULL << IB_USER_VERBS_CMD_CREATE_CQ) | (1ULL << IB_USER_VERBS_CMD_RESIZE_CQ) |		  \
		(1ULL << IB_USER_VERBS_CMD_DESTROY_CQ) | (1ULL << IB_USER_VERBS_CMD_CREATE_QP) |		 \
		(1ULL << IB_USER_VERBS_CMD_MODIFY_QP) | (1ULL << IB_USER_VERBS_CMD_QUERY_QP) |		   \
		(1ULL << IB_USER_VERBS_CMD_DESTROY_QP) | (1ULL << IB_USER_VERBS_CMD_CREATE_SRQ) |		\
		(1ULL << IB_USER_VERBS_CMD_MODIFY_SRQ) | (1ULL << IB_USER_VERBS_CMD_QUERY_SRQ) |		 \
		(1ULL << IB_USER_VERBS_CMD_DESTROY_SRQ) | (1ULL << IB_USER_VERBS_CMD_CREATE_XSRQ) |	  \
		(1ULL << IB_USER_VERBS_CMD_CREATE_DCT) | (1ULL << IB_USER_VERBS_CMD_QUERY_DCT) |		 \
		(1ULL << IB_USER_VERBS_CMD_ARM_DCT) | (1ULL << IB_USER_VERBS_CMD_DESTROY_DCT) |		  \
		(1ULL << IB_USER_VERBS_CMD_CREATE_MR) | (1ULL << IB_USER_VERBS_CMD_REG_FAST_MR) |		\
		(1ULL << IB_USER_VERBS_CMD_DEREG_FAST_MR) | (1ULL << IB_USER_VERBS_CMD_MAP_FRMR_SG) |	\
...
#define ROCE_UVERBS_CMD_MASK																	 \
	((1ULL << IB_USER_VERBS_CMD_GET_CONTEXT) | (1ULL << IB_USER_VERBS_CMD_QUERY_DEVICE) |		\
		...
		(1ULL << IB_USER_VERBS_CMD_DEALLOC_PD) | (1ULL << IB_USER_VERBS_CMD_CREATE_AH) |		 \
		(1ULL << IB_USER_VERBS_CMD_DESTROY_AH) | (1ULL << IB_USER_VERBS_CMD_REG_MR) |			\
		(1ULL << IB_USER_VERBS_CMD_REREG_MR) | (1ULL << IB_USER_VERBS_CMD_DEREG_MR) |			\
		(1ULL << IB_USER_VERBS_CMD_ALLOC_MW) | (1ULL << IB_USER_VERBS_CMD_CREATE_COMP_CHANNEL) | \
		(1ULL << IB_USER_VERBS_CMD_DEALLOC_MW) | (1ULL << IB_USER_VERBS_CMD_CREATE_CQ) |		 \
		(1ULL << IB_USER_VERBS_CMD_RESIZE_CQ) | (1ULL << IB_USER_VERBS_CMD_DESTROY_CQ) |		 \
		...
		(1ULL << IB_USER_VERBS_CMD_ATTACH_MCAST) | (1ULL << IB_USER_VERBS_CMD_DETACH_MCAST) |	\
		...
		(1ULL << IB_USER_VERBS_CMD_CREATE_XSRQ) | (1ULL << IB_USER_VERBS_CMD_OPEN_QP))
#endif
...
struct roce3_device {
	...
	void *pri_roce_dev[ROCE_MAX_PORT_NUM]; // mailbox, ppf store all pf's roce device, to improve the effiency.
	bool is_vroce;
};
...
int roce3_query_port(struct ib_device *device, u32 port_num, struct ib_port_attr *port_attr);
...
int roce3_post_recv(struct ib_qp *ibqp, const struct ib_recv_wr *wr, const struct ib_recv_wr **bad_wr);
