 ...
 *
 * File Name	 : roce_main_extension.c
 * Version	   : v1.0
 * Created	   : 2021/10/18
 * Last Modified : 2021/12/7
 * Description   : The definition of RoCE MAIN extended functions.
 */
...
int roce3_mmap_ext(struct roce3_device *rdev, struct roce3_ucontext *ucontext, struct vm_area_struct *vma)
{
...
void roce3_rdma_cap_ext(struct rdma_service_cap *rdma_cap)
{
	...
	rdma_cap->dev_rdma_cap.roce_own_cap.max_sq_inline_data_sz = ROCE_MAX_SQ_INLINE_DATA_SZ_COMPUTE;
