 ...
 *
 * File Name	 : roce_mix.h
 * Version	   : v2.0
 * Created	   : 2021/3/12
 * Last Modified : 2021/10/13
 * Description   : The definition of macros, data structure, function prototype etc of RoCE mix features.
 */
...
#define ROCE_FW_VER ((ROCE_FW_VER_0 << 32) | (ROCE_FW_VER_1 << 16) | (ROCE_FW_VER_2 << 8) | ROCE_FW_VER_3)
...
typedef struct roce3_get_cos_inbuf {
	u8 sl;
	u8 sgid_index;
	u8 port_num;
	u8 traffic_class;
} roce3_get_cos_inbuf_s;
