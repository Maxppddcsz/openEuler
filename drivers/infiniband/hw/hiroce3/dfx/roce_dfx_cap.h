...
typedef struct roce3_dfx_cap_pa_entry {
	u32 wr_init_pc_h32;
	u32 wr_init_pc_l32;
} roce3_dfx_cap_pa_entry_s;

typedef struct roce3_dfx_cap_tbl {
	roce3_dfx_cap_pa_entry_s pa[2];
} roce3_dfx_cap_tbl_s;

typedef struct roce3_dfx_cap_cfg_tbl {
	u32 ci_index;
