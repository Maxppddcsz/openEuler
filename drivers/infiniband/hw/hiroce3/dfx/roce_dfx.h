 ...
 *
 * File Name	 : roce_dfx.h
 * Version	   : v2.1
 * Created	   : 2020/8/29
 * Last Modified : 2021/10/16
 * Description   : The definition of macros, data structure, function prototype etc of RoCE driver dfx features.
 */
...
#define roce3_dfx_print(fmt, args...)					\
	do {												 \
		(void)printk("[roce3_dfx] : " fmt "\n", ##args); \
	} while (0)
