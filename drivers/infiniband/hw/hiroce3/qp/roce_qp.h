 ...
 * Description   : Define standard kernel RoCE QP realted function prototypes, macros etc,.
 */
...
static inline struct roce3_qp *cqmobj_to_roce_qp(const cqm_object_s *object)
{
	cqm_qpc_mpt_s *qpc_info;
