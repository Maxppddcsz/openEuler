 ...
 *
 * File Name	 : roce_qp_exp.h
 * Version	   : v2.0
 * Created	   : 2021/3/12
 * Last Modified : 2021/12/20
 * Description   : The definition of RoCE QP expanded function prototype, macros etc,. in kernel space.
 */
...
int roce3_qp_modify_exp(struct roce3_device *rdev, struct roce3_qp *rqp, struct ib_qp_attr *attr, int attr_mask,
	enum ib_qp_state cur_state, enum ib_qp_state new_state, u16 vlan_id);
