...
#define ROCE_GID_SET_VLAN_32BIT_VLAID(vlan_id) ((vlan_id) | (((u32)1) << 31)) /* the 31 bit is vlan eable bit */
...
#define ROCE_GID_MAP_TBL_IDX_GET(tunnel, tag, new_gid_type) ((u8)(((tunnel) << 4) | ((tag) << 2) | (new_gid_type)))
