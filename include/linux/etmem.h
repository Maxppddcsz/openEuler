...
extern unsigned long reclaim_folios_list(struct list_head *folio_list,
				int nid, bool putback_flag);
#else /* !CONFIG_ETMEM */
...
static inline unsigned long reclaim_folios_list(struct list_head *folio_list,
					int nid, bool putback_flag)
{
	return 0;
}
