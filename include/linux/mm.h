...
#define VM_HIGH_ARCH_BIT_24	56	/* bit only usable on 64-bit architectures */
...
#define VM_HIGH_ARCH_24	BIT(VM_HIGH_ARCH_BIT_24)
...
#ifdef CONFIG_GMEM
#define VM_PEER_SHARED	VM_HIGH_ARCH_24
#else
