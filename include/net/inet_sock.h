...
#define inet_num		sk.__sk_common.skc_num
	...
	__u8			bind_address_no_port:1,
				...
				defer_connect:1, /* Indicates that fastopen_connect is set
						  ...
						  */
				bpf_defer_connect:1; /* Indicates bpf defer connect is enable.
						      * connect() will perform a fake connect
						      * without send SYN. The actual connect
						      * delayed until the sendmsg
						      */
	__u8			rcv_tos;
	__u8			convert_csum;
	int			uc_index;
