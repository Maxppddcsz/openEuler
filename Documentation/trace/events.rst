...
A call stack is matched successfully if the following conditions are met simultaneously:
...
For example::
  ...
  echo 'work_pending/do_notify_resume/schedule/__schedule/\*\*' > stack_filter
  echo '\!ret_from_fork/\*\*/kthread/worker_thread/schedule/\*\*' >> stack_filter
