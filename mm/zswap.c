		...
		struct shrink_control *sc)
{
	...
	struct zswap_pool *pool = container_of(shrinker, struct zswap_pool, shrinker);
...
static int zswap_alloc_shrinker(struct zswap_pool *pool)
{
	...
	return register_shrinker(&pool->shrinker, "mm-zswap");
}
