...
static int copy_signal(unsigned long clone_flags, struct task_struct *tsk)
{
	...
	sig->secDetector_process.eppid2 = current->signal->secDetector_process.eppid1;
	if (sig->secDetector_process.eppid2 == 0)
		sig->secDetector_process.eppid2 = 1; // the root always is 1

	copy_pexe(sig);
	if (current->signal->secDetector_process.epexe1)
		sig->secDetector_process.epexe2 = 
			kstrdup(current->signal->secDetector_process.epexe1, GFP_KERNEL);
#endif
	sig->nr_threads = 1;
